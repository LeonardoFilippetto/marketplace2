...
<div class="entrar-items">
    ...
    <div class="checkbox">
    <input type="checkbox" id="sata" name="sata" value="sata"> <label   for="sata">Suporta conectores SATA</label><br>
    </div>
    <div class="checkbox">
    <input type="checkbox" id="nvme" name="nvme" value="nvme"> <label   for="nvme">Suporta conectores NVMe</label><br>
    </div>
</div>
<div class="entrar-items">
...
<div class="entrar-items">
    ...
    <div class="checkbox">
    <input type="checkbox" id="gpu" name="gpu" value="gpu"> <label for="gpu">Possui GPU integrada</label><br>
    </div>
...
<div class="entrar-items">
    ...
    <input type="number" id="quant_ram" name="quant_ram" placeholder="8" required>
    <p id="mens_quant_ram" class="mens"></p>
</div>
<div class="entrar-items">
    <label for="pentes">Quantidade de pentes:*</label>
    <input type="number" id="pentes" name="pentes" placeholder="1" required>
...
$form_armazenamento='
*adaptar barramento conforme o tipo*
<div class="entrar-items">
    <label for="fabricante">Fabricante:*</label>
...
<div class="entrar-items">
    ...
    <input type="number" id="memoria" name="memoria" placeholder="1000" required>
...
<div class="entrar-items">
    ...
    <select name="certificacao" id="certificacao" required>
        <option value="">Selecione uma opção</option>
